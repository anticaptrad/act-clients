...
required = ["@anticaptrad/act-validation", "act-validation", "github.com/anticaptrad/act-lib-core/validation/golang", "act_validation"]
for dependency in required:
    assert dependency in text, f"missing public lib-core import: {dependency}"
for forbidden in ("act-validation-server", "golang-server", "act_validation_server"):
