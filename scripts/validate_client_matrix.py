...
if manifest.get("package", {}).get("org") != "anticaptrad" or manifest.get("package", {}).get("name") != "act-clients":
    fail("unexpected package identity")
dependencies = manifest.get("dependencies", {})
if "anticaptrad/act-interfaces" not in dependencies:
    fail("act-interfaces dependency is required")
if "anticaptrad/act-lib" in dependencies:
    fail("do not invent an act-lib dependency before that repository exists")
